...
public class SortedMatrixSearch {
    ...
    private static boolean searchMatrix(int[][] matrix,
                                 int[] upperLeft, int[] lowerRight, int target) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(searchMatrix(mat, num));
        System.out.println(searchMatrixIterative(mat, num));
    }
}
